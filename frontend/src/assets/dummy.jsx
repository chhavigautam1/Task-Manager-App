...
export const LINK_CLASSES = {
    base: "group flex items-center px-4 py-1.75 rounded-xl transition-all duration-300",
...
// APP.JSX
// const user = {
//       avatar: `https://ui-avatars.com/api/?name=${encodeURIComponent((data && data.name) || 'User')}&background=random`
//     };
